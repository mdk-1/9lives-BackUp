...
public class DialogueManager : MonoBehaviour
{
    ...
    public string LoadScene = "GameScene"; // variable for scene this scene will transition too
    ...
    void StartGame()
    {
        SceneManager.LoadScene(LoadScene); // load scene by passing through scene variable
    }
}
