...
public class MenuHandler : MonoBehaviour
{
    ...
    //variable to hold character select from character select panel
    public static string catName = "BlackCat";
    ...
    //button events for character select panel
    public void SelectLando()
    {
        catName = "BlackCat";
        SceneManager.LoadScene(2);
    }
    public void SelectNarla()
    {
        catName = "OrangeCat";
        SceneManager.LoadScene(2);
    }
